        ...
        if passed:
            ...
            if users.find_one(username=username):
                ...
                try:
                    ...
                    response["text"] = "Thank you {0}, you are now registered for J.U.I.L.E".format(first_name)
                except:
                    db.rollback()
                    response["type"] = "error"
                    response["text"] = "There was an error in signing you up for J.U.I.L.E. Please check the information you entered"
        else:
